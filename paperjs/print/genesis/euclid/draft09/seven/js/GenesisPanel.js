...
function GenesisPanel(stage, radius, origin, size, inplace, flipped) {
    // elements
    ...
    // construction
    this.makeCircles(inplace, flipped);
    this.makePoints();
}
...
GenesisPanel.prototype.makeCircles = function (inplace, flipped) {
    ...
    for (var i = 0, l = 7; i < l; i++) {
        ...
        if (stage === this.stage) {
            ...
            if (!flipped) this.group.rotate(180, this.center);
