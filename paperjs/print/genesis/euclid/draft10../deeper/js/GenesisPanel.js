	...
	this.circles.forEach(function (circleA, indexA) {
		this.circles.forEach(function (circleB, indexB) {
			...
			intersects.forEach(function (intersect) {
                ...
                // and add anyways
                this.point.intersects.push(point);
			}, this);
		}, this);
	}, this);
...
GenesisPanel.prototype.markCenterPoints = function () {
    this.point.centers.forEach(function (point) {
        var mark = new shapes.Mark(point);
        this.group.addChild(mark);
    }, this);
};

GenesisPanel.prototype.markIntersectPoints = function () {
    this.point.intersects.forEach(function (point) {
        var mark = new shapes.Mark(point);
        this.group.addChild(mark);
    }, this);
};
