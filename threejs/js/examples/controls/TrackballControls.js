...
// via https://github.com/mrdoob/three.js/issues/1454
function orthoHack(self, eye, factor) {
	if ( self.object instanceof THREE.PerspectiveCamera ) {
	    ...
	    self.object.left *= factor;
	    self.object.right *= factor;
	    self.object.top *= factor;
	    self.object.bottom *= factor;
