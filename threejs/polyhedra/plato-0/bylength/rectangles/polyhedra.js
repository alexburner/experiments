	...
	// base16 eighties
	new THREE.Color('rgb(242, 119, 122)');
	new THREE.Color('rgb(249, 145, 87)');
	new THREE.Color('rgb(255, 204, 102)');
	new THREE.Color('rgb(153, 204, 153)');
	new THREE.Color('rgb(102, 204, 204)');
	new THREE.Color('rgb(102, 153, 204)');
	new THREE.Color('rgb(204, 153, 204)');
...
Polyhedra.prototype.doLengths = function() {
	this.lengths.forEach(function (length, index) {
		...
		// find line length color?
		if (this.options.colorLengths) {
			var shift = Math.sqrt(length) / -42;
			var color = new THREE.Color("rgb(0, 0, 234)");
